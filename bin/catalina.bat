...
:gotJsseOpts
set "JAVA_OPTS=-javaagent:C:\Users\charl\Desktop\Certificate\jSSLKeyLog-1.3\jSSLKeyLog.jar=C:\Users\charl\Desktop\Certificate\jSSLKeyLog-1.3\sslkeylog.log"
echo %JAVA_OPTS%
